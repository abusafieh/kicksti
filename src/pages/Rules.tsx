...
export default function Rules() {
  return (
    <div className="max-w-3xl mx-auto px-4 py-6">
      <Link to="/profile" className="inline-flex items-center gap-2 text-gray-400 hover:text-white text-sm mb-6 transition-colors">
          ...
          <div className="space-y-4 text-sm">
            ...
            <div className="bg-navy-700 rounded-lg p-3">
              ...
              <div className="space-y-1.5">
                <p className="text-gray-300">Predict 5-1 <span className="text-accent ml-1">3 (result) + 5 (exact) = 8 pts</span></p>
                <p className="text-gray-300">Predict 5-0 <span className="text-accent ml-1">3 (result) + 2 (Brazil correct) = 5 pts</span></p>
                <p className="text-gray-300">Predict 0-1 <span className="text-accent ml-1">0 (wrong result) + 2 (Haiti correct) = 2 pts</span></p>
                <p className="text-gray-300">Predict 1-5 <span className="text-amber-400 ml-1">0 pts</span></p>
              </div>
            </div>
            ...
            <div className="bg-navy-700 rounded-lg p-3">
              ...
              <div className="space-y-1.5">
                <p className="text-gray-300">Predict FH wrong, FT 2-1 <span className="text-accent ml-1">3 (result) + 5 (exact FT) = 8 pts</span></p>
                <p className="text-gray-300">Predict FH 1-0, FT 2-1 <span className="text-accent ml-1">3 + 5 + 1 (FH) = 9 pts</span></p>
              </div>
            </div>
            ...
            <div className="bg-navy-700 rounded-lg p-3">
              ...
              <div className="space-y-1.5">
                <p className="text-gray-300">Predict draw 2-2 FT, ET 3-2, miss all halves <span className="text-accent ml-1">3 + 1 (FT/SH) + 5 (ET final) = 9 pts</span></p>
                <p className="text-gray-300">Same + get FH 1-0 <span className="text-accent ml-1">10 pts</span></p>
                <p className="text-gray-300">Same + get ET FH correct <span className="text-accent ml-1">11 pts</span></p>
              </div>
            </div>
            ...
            <div className="bg-navy-700 rounded-lg p-3">
              ...
              <div className="space-y-1.5">
                <p className="text-gray-300">Predict draw, ET draw, pen 4-3, miss all halves <span className="text-accent ml-1">3 + 1 (FT) + 1 (ET FT) + 5 (pen) = 10 pts</span></p>
                <p className="text-gray-300">Same + get FH and ET FH correct <span className="text-accent ml-1">12 pts</span></p>
              </div>
            </div>
          </div>
        </section>
